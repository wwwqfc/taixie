...
gw2_ids['skills_icon'] = '';
gw2_ids['attribute_icon'] = '';
gw2_ids['effects_icon'] = '';
gw2_ids['mini_icon'] = '';
gw2_ids['currencies'] = '';
...
'&attribute_icon=' + gw2_ids['attribute_icon'] +
'&effects_icon=' + gw2_ids['effects_icon'] +
'&mini_icon=' + gw2_ids['mini_icon'] +
...
if( $("[gw2-type='skills'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'skills_' + i ){
$("[gw2-type='skills'][gw2-ids='" + i + "']").empty();
skill = $.parseJSON( data.data.skills[i] );
$("[gw2-type='skills'][gw2-ids='" + i + "']").append(`
...
$("[gw2-type='skills'][gw2-ids='" + i + "']").next('span').addClass('color-' + skill.professions[0]);
else
$("[gw2-type='skills'][gw2-ids='" + i + "']").next('span').addClass('color-default');
}

//特性分支 ===================================================
for(var i in data.data.specializations){
gw2_data['specializations_' + i] = data.data.specializations[i];
if( $("[gw2-type='specializations'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'specializations_' + i ){
$("[gw2-type='specializations'][gw2-ids='" + i + "']").empty();
specialization = $.parseJSON( data.data.specializations[i] );
$("[gw2-type='specializations'][gw2-ids='" + i + "']").append(`
...
<div class="gw2-info-specializations-name bg-color-`+ specialization.profession +`">` + specialization.name + `</div>
...
$("[gw2-type='specializations'][gw2-ids='" + specializations_trait.specialization + "']").append(`
...
if( $("[gw2-type='traits'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'traits_' + i ){
$("[gw2-type='traits'][gw2-ids='" + i + "']").empty();
trait = $.parseJSON( data.data.traits[i] );
$("[gw2-type='traits'][gw2-ids='" + trait.id + "']").append(`
<div class="gw2-info-icon traits-` + i + `"
...
if( $("[gw2-type='items'][gw2-ids='" + i + "']").children(".gw2-info-icon").attr('id') != 'items_' + i ){
$("[gw2-type='items'][gw2-ids='" + i + "']").empty();
item = $.parseJSON( data.data.items[i] );
if( item ){
$("[gw2-type='items'][gw2-ids='" + i + "']").append(`
...
>
<a href="/database/item/` + item.id + `/name/` + item.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
}
...
if( $("[gw2-type='weapons'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'weapons_' + i ){
$("[gw2-type='weapons'][gw2-ids='" + i + "']").empty();
weapon = $.parseJSON( data.data.weapons[i] );
$("[gw2-type='weapons'][gw2-ids='" + i + "']").append(`
...
<a href="/database/item/` + weapon.id + `/name/` + weapon.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//护甲
...
if( $("[gw2-type='armors'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'armors_' + i ){
$("[gw2-type='armors'][gw2-ids='" + i + "']").empty();
armor = $.parseJSON( data.data.armors[i] );
$("[gw2-type='armors'][gw2-ids='" + i + "']").append(`
...
<a href="/database/item/` + armor.id + `/name/` + armor.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//首饰
...
if( $("[gw2-type='trinkets'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'trinkets_' + i ){
$("[gw2-type='trinkets'][gw2-ids='" + i + "']").empty();
$("[gw2-type='trinkets'][gw2-ids='" + i + "']").append(`
...
<a href="/database/item/` + trinket.id + `/name/` + trinket.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
else{
...
if( $("[gw2-type='sigils'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'sigils_' + i ){
$("[gw2-type='sigils'][gw2-ids='" + i + "']").empty();
sigil = $.parseJSON( data.data.sigils[i] );
$("[gw2-type='sigils'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-sigils items-border-` + sigil.rarity + `" 
style="background-image: url(` + sigil.icon + `)"
id="sigils_` + i + `"
gw2-type="sigils"
>
<a href="/database/item/` + sigil.id + `/name/` + sigil.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//符文
...
if( $("[gw2-type='runes'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'runes_' + i ){
$("[gw2-type='runes'][gw2-ids='" + i + "']").empty();
rune = $.parseJSON( data.data.runes[i] );
$("[gw2-type='runes'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-runes items-border-` + rune.rarity + `" 
style="background-image: url(` + rune.icon + `)"
id="runes_` + i + `"
gw2-type="runes"
>
<a href="/database/item/` + rune.id + `/name/` + rune.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//宝石
...
if( $("[gw2-type='gems'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'gems_' + i ){
$("[gw2-type='gems'][gw2-ids='" + i + "']").empty();
gem = $.parseJSON( data.data.gems[i] );
$("[gw2-type='gems'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-gems items-border-` + gem.rarity + `" 
style="background-image: url(` + gem.icon + `)"
id="gems_` + i + `"
gw2-type="gems"
>
<a href="/database/item/` + gem.id + `/name/` + gem.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//食物
...
if( $("[gw2-type='food'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'food_' + i ){
$("[gw2-type='food'][gw2-ids='" + i + "']").empty();
food = $.parseJSON( data.data.food[i] );
$("[gw2-type='food'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-food items-border-` + food.rarity + `" 
style="background-image: url(` + food.icon + `)"
id="food_` + i + `"
gw2-type="food"
>
<a href="/database/item/` + food.id + `/name/` + food.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//升华食物
...
if( $("[gw2-type='ascended_food'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'ascended_food_' + i ){
$("[gw2-type='ascended_food'][gw2-ids='" + i + "']").empty();
ascended_food = $.parseJSON( data.data.ascended_food[i] );
$("[gw2-type='ascended_food'][gw2-ids='" + i + "']").append(`
...
>
<a href="/database/item/` + ascended_food.id + `/name/` + ascended_food.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//通用效果
...
if( $("[gw2-type='utility'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'utility_' + i ){
$("[gw2-type='utility'][gw2-ids='" + i + "']").empty();
utility = $.parseJSON( data.data.utility[i] );
$("[gw2-type='utility'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-utility items-border-` + utility.rarity + `" 
style="background-image: url(` + utility.icon + `)"
id="utility_` + i + `"
gw2-type="utility"
>
<a href="/database/item/` + utility.id + `/name/` + utility.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//灌注
...
if( $("[gw2-type='infusions'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'infusions_' + i ){
$("[gw2-type='infusions'][gw2-ids='" + i + "']").empty();
infusions = $.parseJSON( data.data.infusions[i] );
$("[gw2-type='infusions'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-infusions items-border-` + infusions.rarity + `" 
style="background-image: url(` + infusions.icon + `)"
id="infusions_` + i + `"
gw2-type="infusions"
>
<a href="/database/item/` + infusions.id + `/name/` + infusions.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
//宠物
...
if( $("[gw2-type='pets'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'pets_' + i ){
$("[gw2-type='pets'][gw2-ids='" + i + "']").empty();
pets = $.parseJSON( data.data.pets[i] );
$("[gw2-type='pets'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='gatherings'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'gatherings_' + i ){
$("[gw2-type='gatherings'][gw2-ids='" + i + "']").empty();
gathering = $.parseJSON( data.data.gatherings[i] );
if( gathering ){
$("[gw2-type='gatherings'][gw2-ids='" + i + "']").append(`
...
>
<a href="/database/item/` + gathering.id + `/name/` + gathering.name + `" target="_blank">&nbsp;</a>
</div>`);
}
}
}
...
if( $("[gw2-type='pvp_weapons'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'pvp_weapons_' + i ){
$("[gw2-type='pvp_weapons'][gw2-ids='" + i + "']").empty();
pvp_weapons = $.parseJSON( data.data.pvp_weapons[i] );
$("[gw2-type='pvp_weapons'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='pvp_amulets'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'pvp_amulets_' + i ){
$("[gw2-type='pvp_amulets'][gw2-ids='" + i + "']").empty();
pvp_amulets = $.parseJSON( data.data.pvp_amulets[i] );
$("[gw2-type='pvp_amulets'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='pvp_sigils'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'pvp_sigils_' + i ){
$("[gw2-type='pvp_sigils'][gw2-ids='" + i + "']").empty();
pvp_sigils = $.parseJSON( data.data.pvp_sigils[i] );
$("[gw2-type='pvp_sigils'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='pvp_runes'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'pvp_runes_' + i ){
$("[gw2-type='pvp_runes'][gw2-ids='" + i + "']").empty();
pvp_runes = $.parseJSON( data.data.pvp_runes[i] );
$("[gw2-type='pvp_runes'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='professions_icon'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'professions_icon_' + i ){
$("[gw2-type='professions_icon'][gw2-ids='" + i + "']").empty();
professions_icon = $.parseJSON( data.data.professions_icon[i] );
$("[gw2-type='professions_icon'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='skills_icon'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'skills_icon_' + i ){
$("[gw2-type='skills_icon'][gw2-ids='" + i + "']").empty();
skills_icon = $.parseJSON( data.data.skills_icon[i] );
$("[gw2-type='skills_icon'][gw2-ids='" + i + "']").append(`
...
//状态BUFF图标
for(var i in data.data.effects_icon){
gw2_data['effects_icon_' + i] = data.data.effects_icon[i];
if( $("[gw2-type='effects_icon'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'effects_icon_' + i ){
$("[gw2-type='effects_icon'][gw2-ids='" + i + "']").empty();
effects_icon = $.parseJSON( data.data.effects_icon[i] );
$("[gw2-type='effects_icon'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-effects_icons" 
style="background-image: url(` + effects_icon.icon + `)"
id="effects_icon_` + i + `"
gw2-type="effects_icon"
></div>`);
}
}

//属性图标
for(var i in data.data.attribute_icon){
gw2_data['attribute_icon_' + i] = data.data.attribute_icon[i];
if( $("[gw2-type='attribute_icon'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'attribute_icon_' + i ){
$("[gw2-type='attribute_icon'][gw2-ids='" + i + "']").empty();
attribute_icon = $.parseJSON( data.data.attribute_icon[i] );
$("[gw2-type='attribute_icon'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-attribute_icons" 
style="background-image: url(` + attribute_icon.icon + `)"
id="attribute_icon_` + i + `"
gw2-type="attribute_icon"
></div>`);
}
}

//迷你图标
for(var i in data.data.mini_icon){
gw2_data['mini_icon_' + i] = data.data.mini_icon[i];
if( $("[gw2-type='mini_icon'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'mini_icon_' + i ){
$("[gw2-type='mini_icon'][gw2-ids='" + i + "']").empty();
mini_icon = $.parseJSON( data.data.mini_icon[i] );
$("[gw2-type='mini_icon'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-mini_icons" 
style="background-image: url(` + mini_icon.icon + `)"
id="mini_icon_` + i + `"
gw2-type="mini_icon"
></div>`);
}
...
if( $("[gw2-type='currencies'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'currencies_' + i ){
$("[gw2-type='currencies'][gw2-ids='" + i + "']").empty();
currencies = $.parseJSON( data.data.currencies[i] );
$("[gw2-type='currencies'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='raid_boss'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'raid_boss_' + i ){
$("[gw2-type='raid_boss'][gw2-ids='" + i + "']").empty();
raid_boss = $.parseJSON( data.data.raid_boss[i] );
$("[gw2-type='raid_boss'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='mistlock_instability'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'mistlock_instability_' + i ){
$("[gw2-type='mistlock_instability'][gw2-ids='" + i + "']").empty();
mistlock_instability = $.parseJSON( data.data.mistlock_instability[i] );
$("[gw2-type='mistlock_instability'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='skins'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'skins_' + i ){
$("[gw2-type='skins'][gw2-ids='" + i + "']").empty();
skins = $.parseJSON( data.data.skins[i] );
$("[gw2-type='skins'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='achievements'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'achievements_' + i ){
$("[gw2-type='achievements'][gw2-ids='" + i + "']").empty();
achievements = $.parseJSON( data.data.achievements[i] );
$("[gw2-type='achievements'][gw2-ids='" + i + "']").append(`
...
//专精
for(var i in data.data.masteries){
gw2_data['masteries_' + i] = data.data.masteries[i];
if( $("[gw2-type='masteries'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'masteries_' + i ){
$("[gw2-type='masteries'][gw2-ids='" + i + "']").empty();
masteries = $.parseJSON( data.data.masteries[i] );
$("[gw2-type='masteries'][gw2-ids='" + i + "']").append(`
<div class="gw2-info-icon gw2-info-masteriess gw2-masteries-icon" 
style="background-image: url(` + masteries.region_icon + `)"
id="masteries_` + i + `"
gw2-type="masteries"
></div>`);
}
...
if( $("[gw2-type='colors'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'colors_' + i ){
$("[gw2-type='colors'][gw2-ids='" + i + "']").empty();
colors = $.parseJSON( data.data.colors[i] );
$("[gw2-type='colors'][gw2-ids='" + i + "']").append(`
...
if( $("[gw2-type='minis'][gw2-ids='" + i + "']").children('.gw2-info-icon').attr('id') != 'minis_' + i ){
$("[gw2-type='minis'][gw2-ids='" + i + "']").empty();
minis = $.parseJSON( data.data.minis[i] );
$("[gw2-type='minis'][gw2-ids='" + i + "']").append(`
...
<template v-if="flag == 'SoulBindOnUse'">获得后灵魂绑定</template>
...
gw2_type == 'effects_icon' ||
gw2_type == 'attribute_icon' ||
gw2_type == 'mini_icon'
){
var app = new Vue({
el: '#app-info',
...
<div class="gw2-info-box-items-content">
<div class="gw2-info-box-items-title">
<div class="gw2-info-box-items-icon" :style="'background-image: url(' + mastery.icon + ')'" ></div>
<span class="gw2-info-box-items-name gw2-info-Exotic"><span v-html="mastery.name"></span></span>
</div>
<div class="gw2-info-box-items-rows">
<div class="gw2-info-box-items-row">
<span class="color-Junk">
<span v-html="mastery.instruction"></span>
</span>
</div>
</div>
</div>
